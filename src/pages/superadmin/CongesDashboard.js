...
const Leave = () => {
  ...
  const fetchInsights = async () => {
    try {
      const res = await axios.get("http://localhost:5000/api/leave/insight", {
        params: { driver },
      });
  ...
  const fetchDrillData = async () => {
    try {
      const res = await axios.get("http://localhost:5000/api/leave/drill", {
  ...
  const fetchPieData = async () => {
    try {
      const res = await axios.get("http://localhost:5000/api/leave/pie", {
        params: { driver },
      });
